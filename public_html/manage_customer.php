		...
		<nav aria-label="breadcrumb">
          ...
          <h1 class="h2">Customers</h1>
            <div class="btn-toolbar mb-2 mb-md-0">
              ...
              <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#customer_add_modal"><i class="fas fa-plus"></i>&nbsp;Add Customers</a>
            </div>
          </div>
			...
			<table id="example_customer" class="display" style="width:100%; font-size: 18px;">
				...
				$count=1;
					...
					$query=mysqli_query($conn,"SELECT `id`, `company_name`, `gst`, `mobile`, `address` FROM `customers`");
