...
<div class="container" style="margin-top:2%;margin-bottom: 2%">
    ...
    ?>
			<tr>
	            ...
	            {
	            ?>
	            	<td><span class="btn btn-success" style="width:5rem"><span class="fas fa-check"></span>&nbsp;&nbsp;Paid</span></td>
	            <?php
	            }
	            else
	            {
	            ?>
	            	<td><span class="btn btn-warning" style="width:5rem"><i class="far fa-hand-paper"></i>&nbsp;&nbsp;Due</span></td>
	            <?php
	            }
	            ?>
